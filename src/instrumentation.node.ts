...
export async function register() {
  ...
  const tracesEndpoint =
    process.env.OTEL_EXPORTER_OTLP_TRACES_ENDPOINT || 'https://otlp.us5.datadoghq.com/v1/traces';
  const metricsEndpoint =
    process.env.OTEL_EXPORTER_OTLP_METRICS_ENDPOINT || 'https://otlp.us5.datadoghq.com/v1/metrics';
